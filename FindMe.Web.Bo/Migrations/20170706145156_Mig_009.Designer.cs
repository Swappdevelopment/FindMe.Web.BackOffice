...
namespace FindMe.Web.Bo.Migrations
{
    ...
    [Migration("20170706145156_Mig_009")]
    partial class Mig_009
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FindMe.Data.Models.Account", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FindMe.Data.Models.AccountIP", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("Account_Id", "IPAddress_Id")
                        .IsUnique();
            ...
            modelBuilder.Entity("FindMe.Data.Models.AddressTripAdWidgetValue", b =>
                {
                    ...
                    b.Property<string>("SmallValue")
                        .HasColumnName("SmallValue")
                        .HasMaxLength(512);
            ...
            modelBuilder.Entity("FindMe.Data.Models.RegisterCompany", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("CompanyName_Comp")
                        .IsRequired()
                        .HasColumnName("CompanyName_Comp")
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("FindMe.Data.Models.SuggestAddress", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ContactFName_Comp")
                        .IsRequired()
                        .HasColumnName("ContactFName_Comp")
                        .HasMaxLength(128);
                    ...
                    b.Property<string>("ContactLName_Comp")
                        .IsRequired()
                        .HasColumnName("ContactLName_Comp")
                        .HasMaxLength(128);
                    ...
                    b.HasIndex("ContactFName_Comp");

                    b.HasIndex("ContactLName_Comp");

                    b.HasIndex("UID")
                        .IsUnique();

                    b.ToTable("SuggestAddresses");
                });
            ...
            modelBuilder.Entity("FindMe.Data.Models.AccountIP", b =>
                {
                    b.HasOne("FindMe.Data.Models.Account", "Account")
                        .WithMany("AccountIPs")
